 ...
 */
@ApiModel(description = "The driver of the specified vehicle. The driver can only operate the vehicle within the given time interval.")
@JsonPropertyOrder({
...
public class Driver {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Interval during which the driver is available. The route has to start and end within this interval. All opening intervals outside of this interval are not considered. The interval is restricted to a maximum duration of twenty four hours.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The maximum driving time of the driver [s].   The maximum driving time is considered as infinite if it is not set.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The maximum travel time of the driver [s]. The travel time contains all waiting, service and driving times.  The maximum travel time is considered as infinite if it is not set.")
  @JsonIgnore
