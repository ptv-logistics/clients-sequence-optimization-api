...
namespace PTV.Developer.Clients.sequenceoptimization.Model
{
    ...
    public partial class Violation : IEquatable<Violation>, IValidatableObject
    {
        ...
        /// <param name="timeExceedance">Specifies a violation that involves a time limit: Time by which the limit is exceeded. Is only filled for the following violation types: DRIVER_AVAILABILITY, OPENING_INTERVAL, MAXIMUM_TRAVEL_TIME_OF_DRIVER and MAXIMUM_DRIVING_TIME_OF_DRIVER..</param>
        ...
        public Violation(ViolationType type = default(ViolationType), int timeExceedance = default(int), List<int> capacityExceedance = default(List<int>))
        {
            this.Type = type;
        ...
        /// </summary>
        /// <value>Specifies a violation that involves a time limit: Time by which the limit is exceeded. Is only filled for the following violation types: DRIVER_AVAILABILITY, OPENING_INTERVAL, MAXIMUM_TRAVEL_TIME_OF_DRIVER and MAXIMUM_DRIVING_TIME_OF_DRIVER.</value>
