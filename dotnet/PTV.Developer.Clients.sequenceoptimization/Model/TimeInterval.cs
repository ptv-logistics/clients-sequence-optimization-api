...
namespace PTV.Developer.Clients.sequenceoptimization.Model
{
    ...
    public partial class TimeInterval : IEquatable<TimeInterval>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="TimeInterval" /> class.
        /// </summary>
        /// <param name="start">The beginning of the time interval according to [RFC 3339](https://tools.ietf.org/html/rfc3339). The date must not be before 1970-01-01T00:00:00+00:00 nor after 2037-12-31T23:59:59+00:00. The date must provide an offset. (required).</param>
        /// <param name="end">The end of the time interval according to [RFC 3339](https://tools.ietf.org/html/rfc3339). The date must not be before 1970-01-01T00:00:00+00:00 nor after 2037-12-31T23:59:59+00:00. The date must provide an offset. (required).</param>
        ...
        /// </summary>
        /// <value>The beginning of the time interval according to [RFC 3339](https://tools.ietf.org/html/rfc3339). The date must not be before 1970-01-01T00:00:00+00:00 nor after 2037-12-31T23:59:59+00:00. The date must provide an offset.</value>
        ...
        /// </summary>
        /// <value>The end of the time interval according to [RFC 3339](https://tools.ietf.org/html/rfc3339). The date must not be before 1970-01-01T00:00:00+00:00 nor after 2037-12-31T23:59:59+00:00. The date must provide an offset.</value>
