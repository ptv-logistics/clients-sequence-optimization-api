...
namespace PTV.Developer.Clients.sequenceoptimization.Model
{
    ...
    public partial class OptimizedRouteResponse : IEquatable<OptimizedRouteResponse>, IValidatableObject
    {
        ...
        public OptimizedRouteResponse(OperationStatus status = default(OperationStatus), OptimizedRoute optimizedRoute = default(OptimizedRoute), ErrorResponse error = default(ErrorResponse))
        {
            this.Status = status;
